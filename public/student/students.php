        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          <div class="container px-6 mx-auto grid">
            <div class="w-full overflow-x-auto">
              <div class="my-6">
                <a href="add_student_form.php" class=" px-10 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green">Add Student</a>
              </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold"><?php echo $StudentName?></p>
                    ...
                    <td>
                          ...
                          <a href="update_student.php?StudentId=<?php echo $StudentId?>"><span
                          class="px-2 py-1 text-green-700 bg-green-100 rounded dark:bg-green-700 dark:text-green-100"
                          name="submit"
                          >Update</span></button>
