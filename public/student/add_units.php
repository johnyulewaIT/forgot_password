    ...
    >
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <div class="px-6 my-6">
            <button
              class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue"
            >
              Create account
      ...
      <div class="flex flex-col flex-1">
        ...
        >
          ...
          <!-- Add students form starts here...--->

        <form action="includes/add_units.inc.php" method="post">
          <label class="block mt-4 text-sm">
            <span class="text-gray-700 dark:text-gray-400">Unit Id</span>
            ...
            >
              <input
                ...
                placeholder="Input Unit Id" name="unitId"
              />
              <div
          ...
          <label class="block mt-4 text-sm">
            ...
            >
              <input
                class="block w-full pr-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                placeholder="Input Unit Name" name="unitName"
              />
              <div
                class="absolute inset-y-0 right-0 flex items-center mr-3 pointer-events-none"
              >
          ...
          <label class="block mt-4 text-sm">
            ...
            >
              <input
                class="block w-full pr-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                placeholder="Input Course" name="course"
              />
              <div
                class="absolute inset-y-0 right-0 flex items-center mr-3 pointer-events-none"
              >
