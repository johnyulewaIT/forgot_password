        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          <div class="container px-6 mx-auto grid">
            <div class="w-full overflow-x-auto">
              <div class="my-6">
                <a href="add_exams.php" class=" px-10 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green">Add Exam(s)</a>
              </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold"><?php echo $examName?></p>
                    ...
                    <td class="px-4 py-3 text-xs">
                      <a href="update_exam.php?id=<?php echo $id?>">
                      <span
                        class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"
                      >
                      Activate
