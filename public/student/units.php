        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          <div class="container px-6 mx-auto grid">
            <div class="w-full overflow-x-auto">
              <div class="my-6">
                <a href="add_units.php" class=" px-10 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green">Add Units</a>
              </div>
              <table class=" my-6 w-full whitespace-no-wrap ">
                ...
                >
                  ...
                  <td class="px-4 py-3">
                    ...
                    <p class="font-semibold"><?php echo $unitName?></p>
                    ...
                    <td class="px-4 py-3 text-xs">
                      <a href="update_units.php?id=<?php echo $id?>"
                      >
                      <span
